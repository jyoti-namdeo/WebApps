	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
					...
					try{
						...
						while (cursor.hasNext()) {
							...
							System.out.println("Image is "+imageSrc);
					...
					out.println("");
						...
						out.println("<select align='right' name='pizzaSize'>");
						  out.println("<option value='small'>Small Size</option>");
						  out.println("<option value='medium'>Medium Size - +$4</option>");
						  out.println("<option value='large'>Large Size - +$6</option>");
